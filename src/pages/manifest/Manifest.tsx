          ...
          <div className="content">
            <div id="mission" className="mission">
              ...
              <ol style={{ listStyleType: 'decimal' }}>
                ...
                <li>
                  To revolutionize the chess experience by integrating immersive
                  narratives and innovative gameplay enhancements, encouraging
                  players to think creatively and explore new strategies beyond
                  traditional gameplay.
                </li>
                <li>
                  To cultivate a vibrant community of chess enthusiasts, where
                  collaboration, creativity, and shared mastery are at the heart
                  of a continuously evolving and dynamic chess experience.
                </li>
              </ol>
            </div>
            <div id="about" className="about">
              ...
              <p>
                The concept for this project was first envisioned in 2017 with a
                mission to create a powerful chess platform that fosters both
                technical excellence and creative exploration. As an open-source
                initiative, it is licensed under the GPL 3. (learn more about{' '}
                <a
                  target="_blank"
                ...
                , providing an extensive collection of tagged, themed, and rated
                puzzles to challenge and engage users. The engine theory,
            ...
            <div id="patches" className="patches">
              <h2>Patch Notes v1.0.0 - Current Updates to the game.</h2>
              <ul>
                <li>
                  Basic and advanced engine search and evaluation concepts
                </li>
                <li>
                  Recognized engine variants
                  <ul>
                    <li>x check</li>
                    <li>king of the hill (throne)</li>
                    <li>racing kings</li>
                    <li>crazy house</li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      spectre (5x5 pattern) - All opposite color squares of the
                      square the piece sits on
                    </li>
                    <li>
                      wraith (5x5 pattern) - All same color squares as the piece
                      sits on
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      unicorn (5x5 pattern) - Jump to Bishop’s second square,
                      Rook’s first square
                    </li>
                    <li>
                ...
                <li>
                  Arcana: various engine-recognized badges that a single player
                  may hold that provides certain on-board advantages
                  <ul>
                    <li>summon a piece to the board</li>
                    <li>
                      royalty: a piece moves like another piece on chosen square
                      for 4 turns (Q, T, M, V)
                    </li>
                    <li>entangle: freeze a piece to a square for 4 turns</li>
                    <li>
                      summon exile (a static “duck” for the rest of the game)
                    </li>
                    <li>swap adjacent pieces with exceptions</li>
                    <li>swap most friendly major and minor pieces</li>
                    <li>
                      alternate move patterns, no capturing: (P - right, left,
                      back. B - Rook’s first move. N - King’s pattern. R -
                      Bishop’s first square)
                    </li>
                    <li>suspend: prevent checks and captures for 3 turns</li>
                    <li>
                      3 levels of engine move recommendations (piece only /
                      summon square only, Full move suggestion, Look at the
                      principle variation - 4 moves ahead)
                    </li>
                    ...
                    <li>
                      inheritance: promote Pawns on the second to last rank
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <div id="privacy" className="privacy">
              ...
              <ul>
                <li>
                  Account Creation and Authentication: To create and manage your
                  account on our app
                </li>
                <li>
              ...
              <p>
                ...
                system is impenetrable. We cannot guarantee the absolute
              ...
              <p>
                ...
                will be posted on this page, and the Last updated date at the
                top will be revised. We encourage you to review this Privacy
